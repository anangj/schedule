<x-app-layout>
    <div class="space-y-8">
        <div class="items-center justify-between block mb-6 sm:flex">
            ...
            <div class="text-end">
                <a class="btn inline-flex justify-center btn-dark rounded-[25px] items-center !p-2 !px-3" href="{{ route('doctorSpecialist.index') }}">
        ...
        <div class="overflow-hidden rounded-md">
            <div class="px-5 bg-white dark:bg-slate-800 py-7">
                <form method="POST" action="{{ route('doctorSpecialist.update', $doctors)}}">
                    @csrf
                    @method('PUT')
