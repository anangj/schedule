        ...
        <div class="card xl:col-span-2">
            <div class="card-body flex flex-col p-6">
                <header class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                    <div class="flex-1">
                        <div class="card-title text-slate-900 dark:text-white">Add Doctor</div>
                    </div>
                ...
                <div class="card-text h-full ">
                    <form action="{{ route('doctors.store') }}" method="POST">
                                ...
                                <div class="tab-pane fade show active" id="tabs-personal" role="tabpanel"
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
                                        <div class="input-area relative">
                                            ...
                                            <input type="text" name="idCard" id="idCard" class="form-control" placeholder="ID Card">
                                        </div>
                                        <div class="input-area relative">
                                            <label for="namaDokter" class="form-label">Nama
                                                Dokter</label>
                                            <input type="text" name="namaDokter" id="namaDokter" class="form-control" placeholder="Nama Dokter">
                                        </div>
                                        <div class="input-area relative">
                        ...
                        <button class="btn inline-flex justify-center btn-primary rounded-[25px] mt-5">Save</button>
                    </form>
                </div>
            </div>
        </div>
