<x-app-layout>
        ...
        <div class="rounded-md overflow-hidden">
            <div class="bg-white dark:bg-slate-800 px-5 py-7">
                <form id="eventForm" method="POST" action="{{ route('events.store') }}" enctype="multipart/form-data">
                    ...
                    <div id="loadingModal" class="fixed inset-0 bg-gray-800 bg-opacity-75 flex justify-center items-center" style="display: none;">
    ...
    <script>
        document.getElementById('eventForm').addEventListener('submit', function(e) {
            document.getElementById('loadingModal').style.display = 'flex'; // Show modal
        });
    </script>
    @endpush
</x-app-layout>
