            ...
            <div class="card">
                <div class="card-header noborder -mb-6">
                    ...
                    <div id="filterForm" class="card mb-6 p-5 hidden">
                        <form method="POST" action="{{ route('nurses.index') }}">
                            @csrf
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <!-- Filter by Nurse Name -->
                                <div>
                                    <label for="employee_name">Nurse Name</label>
                                    <select name="employee_name" id="employee_name" class="form-control">
                                        <option value="">Select a Nurse</option>
                                        @foreach ($listNurses as $nurse)
                                            <option value="{{ $nurse->employee_name }}" {{ request('employee_name') == $nurse->employee_name ? 'selected' : '' }}>
                                                {{ $nurse->employee_name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="mt-4">
                                ...
                                <a href="{{ route('nurses.index') }}" class="btn btn-light">Reset</a>
                            </div>
                        </form>
                    </div>
                </div>
